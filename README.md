...
| `product-team-kit` | `0.4.4` | 기획 입력을 기능설계서와 정책서 초안으로 정리하고, 초안 폴더 단위로 기능설계서와 정책서를 함께 검토해 발행 전 근거·결정 범위·실행 가능성을 확인합니다. | `plan-format`, `plan-review` | [README](./product-team-kit/README.md) |

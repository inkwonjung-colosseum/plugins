...
| 플러그인 | 버전 | 목적 | 대표 스킬 | 문서 |
|---|---:|---|---|---|
| `confluence-export-kit` | `0.1.1` | Confluence export 및 local export-index workflow. auth/config 설정, page/space/org/page-with-descendants export, 로컬 Markdown 색인을 다룹니다. | `set-config`, `show-config`, `export-page`, `export-page-with-descendant`, `export-space`, `export-org`, `index-export`, `help` | [README](./confluence-export-kit/README.md) |

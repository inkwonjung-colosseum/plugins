...
| 플러그인 | 목적 | 문서 |
|---|---|---|
| `confluence-export-kit` | Confluence export 전용 플러그인: auth 설정, page-tree/keyword/label export, `confluence-markdown-exporter` bootstrap | [README](./confluence-export-kit/README.md) |
...
- `marketplace.json`은 GitHub 저장소 또는 정적 URL로 배포 가능합니다.

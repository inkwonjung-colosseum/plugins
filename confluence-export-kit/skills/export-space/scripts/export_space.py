...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "space_url",
        help="Confluence space URL to export (e.g. https://company.atlassian.net/wiki/spaces/SPACEKEY)",
    )
    parser.add_argument(
        "output_path",
        nargs="?",
...
def main() -> int:
    ...
    base_url = extract_base_url(args.space_url)
    ...
    result = run_command([cme_path, "spaces", args.space_url], env=env)

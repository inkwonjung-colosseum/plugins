...
0.2.17에서도 `planning-format` 기본 저장 성공 출력은 정책서·기능설계서 전문을 화면에 펼치지 않습니다. 그래서 `planning-review` 0개 인자 conversation 모드는 직전 출력의 `## 저장 파일`을 안전하게 읽을 수 있습니다.
...
| [output-contract.md](../../../planning-kit/skills/planning-format/references/output-contract.md) | 0.2.17 저장 파일, `--no-save`, parser boundary |

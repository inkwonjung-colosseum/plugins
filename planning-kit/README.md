...
- 0.2.10 검증 기대값은 [docs/prd/fixtures/prd-0.2.10-fixtures.yml](./docs/prd/fixtures/prd-0.2.10-fixtures.yml)에 보관합니다. 현재 저장소에는 fixture runner가 없으므로 이 파일은 PRD §14의 golden expectation 데이터입니다.

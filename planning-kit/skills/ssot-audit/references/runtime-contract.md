...
6. 1차 WebFetch는 의무다.
7. connector fallback은 `../planning-format/references/runtime.md`를 1회 Read해서 공유한다.
...
- `../planning-format/references/runtime.md` — 외부 URL fetch + connector fallback 공통 규칙.
- `../planning-format/references/conversion.md` — 이미지 multimodal·통합 본문 합류 룰 참고.
- `../planning-review/references/review-axes.md` — 검증 가능한 조건 부재 판단 참고.

...
기획 입력을 현재 템플릿에 맞춰 기능설계서와 정책서 초안으로 정리하는 기획팀 도구. Claude Code와 Codex 양쪽에서 동작한다.
...
```
/planning-team-kit:plan-format "주문 취소 기능: 주문 취소 정책과 화면 동작 정리..."
/planning-team-kit:plan-format /path/to/planning-notes.md
...
```
/planning-team-kit:plan-format "기획 입력 또는 파일경로"
    ↓ 입력에서 기능명 추출
    ...
    ↓
(선택) /planning-team-kit:plan-review <파일경로>
    ↓ 병렬 fresh-context reviewer 4개로 4관점 검토

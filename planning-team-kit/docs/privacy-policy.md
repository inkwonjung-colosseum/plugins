...
- Timestamped `planning-drafts` drafts saved under `planning/topic-slug--YYYY-MM-DD-HHMMSS/`
...
## What this plugin does not do in v0.1

- It does not automatically publish content to Jira, Confluence, Slack, Google Drive, Notion, or other third-party services.

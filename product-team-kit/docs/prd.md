...
- 문서 상태: 초안
- 기준일: 2026-05-07
- 대상 버전: product-team-kit 0.6.9
- 관련 기능 문서: [feature-definition.md](./feature-definition.md)
- 관련 문서: [README](../README.md), [skills-workflow.md](./skills-workflow.md)

## 1. 한 줄 요약

`product-team-kit`은 비구조 기획 입력을 로컬 기능설계서와 정책서 초안으로 정리하고, 팀 문서 반영 전에 Product Docs SSOT 근거로 충돌과 착수 가능성을 검토하는 제품팀 도구다.
...
또한 초안 생성과 발행 전 검토가 분리되어 있지 않으면, AI가 만든 문서가 기존 Product Docs SSOT와 충돌하는지 확인하지 못한 채 디자인, 개발, QA, 운영 후속 업무로 넘어갈 위험이 있다.
...
| 디자인 / 개발 / QA / 운영 담당자 | 대화 맥락 없이 문서만 보고 다음 업무를 시작할 수 있는지 판단 |
...
- Product Docs SSOT 근거 기반 4축 발행 전 검토
- `통과`, `조건부 통과`, `수정 필요`, `올바른 검토 대상이 아님` 판정
- 디자인, 개발, QA, 운영 관점의 착수 가능성 표시

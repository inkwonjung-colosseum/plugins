...
발행 전 확인 항목:
| 축 | ID | 제목 | 위치 | 근거 인용 | 영향 | 확인할 내용 | 확인 후 처리 |
|---|---|---|---|---|---|---|---|
| [축] | COND-001 | [제목] | [문서 > 섹션] | [짧은 인용] | [영향] | [확인 조건] | [문서 반영 여부] |
...
필수 수정 항목:
| 축 | ID | 제목 | 위치 | 근거 인용 | 영향 | 어떻게 고칠지 | 수용 기준 |
|---|---|---|---|---|---|---|---|
| [축] | FIX-001 | [제목] | [문서 > 섹션] | [짧은 인용] | [영향] | [수정 포인트] | [확인 기준] |

발행 전 확인 항목:
| 축 | ID | 제목 | 위치 | 근거 인용 | 영향 | 확인할 내용 | 확인 후 처리 |
|---|---|---|---|---|---|---|---|
| [축] | COND-001 또는 없음 | [제목 또는 없음] | [문서 > 섹션 또는 없음] | [짧은 인용 또는 없음] | [영향 또는 없음] | [확인 조건 또는 없음] | [문서 반영 여부 또는 없음] |
...
참고: SSOT 기반 충돌 검증은 수행하지 않았습니다. 수정 후 plan-review 재실행 시 전체 4축 검토가 진행됩니다.
